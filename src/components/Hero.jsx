        ...
        <div className="hero">
            <div className="flex justify-around lg:flex-row hero-content mt-7 md:mt-0 flex-col lg:mx-16">
                <div className="lg:w-5/12 lg:ml-5 xl:ml-0 text-center lg:text-left mt-10 bg-[url('/src/images/herobg.svg')] bg-cover bg-[top_2rem]" >
                    <h1 className="inline text-transparent bg-clip-text bg-gradient-to-r from-slate-800 to-violet-900 drop-shadow-lg 2xl:text-7xl text-5xl md:text-6xl font-bold">Welcome <br /> to Kerasoft </h1>
                ...
                <div className='lg:w-7/12 w-10/12 max-h-screen'>
