...
function Navbar() {
    ...
    return ( 
        <div data-theme={(pathname==='/blogspot' && dark) && 'night'} className= {`navbar shadow sticky top-0 z-10 opacity-[.90] dark:opacity-[.98] px-0 xs:px-2`}>
                ...
                <div className="flex-1">
                    <Link className={`px-1 rounded kerasoftLogo text-primary text-2xl dark:text-[#fefefe]`} to={"/home"}>{`ker^s<>ft`}</Link>
