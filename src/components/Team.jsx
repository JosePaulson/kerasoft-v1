...
function Team() {
  return (
    <div className="relative pb-[2vw] pt-[2vw] opacity-100">
      ...
      <div className="text-center relative  lg:border-b-[transparent] border-secondary mb-12 mt-10 md:mt-4">
        <h2 className='absolute top-5 -left-8 rotate-[270deg] bg-transparent inline-block text-lg uppercase font-medium px-2 text-purple-800 tracking-wider'>key people</h2>
      </div>
